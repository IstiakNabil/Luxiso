 ...
 * Filters design: a solid brown (#8A6A2E) bar with a bold
  ...
  return (
    <div className="font-loomino w-full">
      <button
        ...
        aria-expanded={open}
        className="flex h-[48px] w-full items-center gap-4 bg-[#5C1626] px-4 text-left"
      >
      ...
      {open && (
        <div className="border border-t-0 border-[#CBCBCB] bg-[#F6EFE8] p-4">
          {children}
        </div>
      )}
    </div>

  ...
  return (
    <header className="font-loomino flex h-[64px] items-center justify-between border-b border-[#E4DACA] bg-white px-8">
      ...
      <div className="flex items-center gap-5">
        ...
        >
          <Bell size={20} />
          <span className="absolute -right-0.5 -top-0.5 h-2 w-2 rounded-full bg-[#5C1626]" />
        </button>

        <div className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#5C1626] text-[13px] font-bold text-white">

...
function ProductInfo({ product }: ProductInfoProps) {
  ...
  return (
    <div className="font-loomino flex w-full flex-col">
      ...
      <p className="mt-6 text-[16px] leading-[1.8] text-[#1F1210]">
      ...
      {/* Price */}
      <div className="mt-8">
        <span className="text-[28px] font-semibold text-[#1F1210]">
      ...
      {selectedVariant && (
        <div className="mt-4 space-y-1 text-[14px] text-[#606060]">
          <p>
            <span className="font-medium text-[#1F1210]">
              SKU:
            </span>{" "}
            {selectedVariant.sku}
          </p>
      ...
      <div className="mt-5 flex items-center gap-2 text-[15px]">
        <Star
          size={18}
          className="fill-[#8A6A2E] stroke-[#8A6A2E]"
        />
        <span className="font-medium text-[#1F1210]">

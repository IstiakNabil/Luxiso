  ...
  return (
    <div className="max-w-[560px]">
      <p className="text-[16px] leading-[1.8] text-[#606060]">
        ...
        code to{" "}
        <span className="font-semibold text-[#1F1210]">
          {email}
        </span>
      ...
      {!otpSent ? (
        <button
          ...
          className="mt-8 h-10 w-full lg:h-[48px] lg:w-[240px] bg-[#5C1626] text-[14px] text-white transition hover:opacity-90 disabled:opacity-50"
        >
          {forgot.isPending
            ? "Sending..."
        ...
        >
          ...
          <div className="flex items-center gap-4 pt-2">
            <button
              ...
              className="h-10 w-full lg:h-[48px] lg:w-[200px] bg-[#5C1626] text-[14px] text-white transition hover:opacity-90 disabled:opacity-50"
            >
              {reset.isPending
                ? "Updating..."
                : "Change Password"}
            ...
            <button
              ...
              onClick={requestOtp}
              disabled={forgot.isPending}
              className="text-[15px] text-[#8A6A2E] hover:underline disabled:opacity-50"
            >
              Resend Code
            </button>
          </div>

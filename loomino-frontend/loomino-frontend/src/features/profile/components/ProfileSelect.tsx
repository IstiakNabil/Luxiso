    ...
    <div>
      ...
      <div className="relative">
        <select
          id={fieldId}
          {...props}
          className="h-[52px] w-full appearance-none border border-[#B9AE97] bg-transparent px-4 pr-10 text-[15px] outline-none transition focus:border-[#8A6A2E] disabled:bg-[#EDE7DA] disabled:text-[#7A7060]"
        >
          {options.map((option) => (

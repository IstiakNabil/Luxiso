...
function SizeSelector({
  ...
  return (
    <div className="mt-8">
      <label
        htmlFor="size"
        className="mb-2 block text-[16px] font-medium text-[#1F1210]"
      >
        Size
      </label>
  ...
  className="h-[52px] w-full border border-[#B9AE97] bg-transparent px-4 text-[15px] outline-none focus:border-[#8A6A2E] disabled:opacity-50"
>

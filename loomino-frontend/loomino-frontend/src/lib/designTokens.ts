...
export const COLORS = {
  ...
  // Brand
  brown: "#8A6A2E", // primary accent / links (breadcrumb active)
  greenDark: "#5C1626", // primary/primary750 — dark buttons
  green: "#8C3A4E", // secondary green

  // Primary tints
  primary25: "#F6EFE8", // panel background
  primary50: "#E3D2C7", // borders / subtle fills

  ...
  return (
    <div className="font-loomino">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-[26px] font-bold text-[#3A1620]">
            Dashboard
          </h1>
      ...
      <div className="mt-6 flex flex-col items-start justify-between gap-4 rounded-2xl bg-[#211B12] p-6 md:flex-row md:items-center">
        ...
        <div className="flex gap-3">
          <Link
            to="/admin/orders"
            className="rounded-lg bg-[#5C1626] px-4 py-2 text-[13px] font-medium text-white"
          >
            View Orders
          </Link>
          <Link
      ...
      <div className="mt-6 rounded-2xl border border-[#EFE9DE] bg-white">
        <div className="flex items-center justify-between border-b border-[#EFE9DE] px-6 py-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-[15px] font-semibold text-[#3A1620]">
                Recent Orders
              </p>
              <p className="text-[12px] text-[#B08C7A]">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead>
              <tr className="text-[11px] uppercase tracking-[0.5px] text-[#B08C7A]">
            ...
            <tbody>
              {ordersLoading && (
                <tr>
                  <td
                    colSpan={5}
                    className="px-6 py-8 text-center text-[14px] text-[#B08C7A]"
                  >
                    Loading orders…
                  </td>
                </tr>
              ...
              {recentOrders.map((order) => (
                ...
                >
                  <td className="px-6 py-4 font-mono text-[12px] text-[#8A6A2E]">
                    #{order.order_number}
                  </td>
                  <td className="px-6 py-4 text-[#3A2E1B]">
                    {order.customer}
                  </td>
                  <td className="px-6 py-4 font-semibold text-[#3A1620]">
      ...
      <div className="mt-6 rounded-2xl border border-[#EFE9DE] bg-white">
        ...
        <div className="grid grid-cols-2 gap-3 p-6 sm:grid-cols-3 xl:grid-cols-5">
          {categoriesLoading && (
            <p className="col-span-full py-4 text-center text-[14px] text-[#B08C7A]">
              Loading categories…
            </p>
          )}
          ...
          {(categories ?? []).map((cat) => (
            ...
            >
              ...
              <div className="min-w-0">
                <p className="truncate text-[13px] font-medium text-[#3A1620]">
                  {cat.name}
                </p>
                <p className="text-[12px] text-[#B08C7A]">

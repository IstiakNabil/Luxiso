    ...
    <div className="font-loomino flex min-h-screen items-center justify-center bg-[#211B12] px-4">
      <div className="w-full max-w-[420px] rounded-2xl bg-white p-8 shadow-xl">
        <div className="mb-7 text-center">
          <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl bg-[#5C1626]">
        ...
        {step === "request" ? (
          <>
            ...
            <button
              ...
              disabled={submitting}
              className="flex h-[46px] w-full items-center justify-center gap-2 rounded-lg bg-[#5C1626] text-[14px] font-semibold text-white transition hover:opacity-90 disabled:opacity-60"
            >
              {submitting ? (
                <>
                  <Loader2
          ...
          <>
            ...
            <button
              ...
              className="mt-4 w-full text-center text-[13px] text-[#8A7C64] hover:text-[#8A6A2E]"
            >

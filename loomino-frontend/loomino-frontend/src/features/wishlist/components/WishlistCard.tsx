      ...
      <div className="mt-4 flex items-start justify-between px-2">
        <div className="flex flex-col gap-2">
          <Link
            ...
            className="text-[14px] font-bold capitalize leading-[1.4] text-[#1F1210] hover:underline lg:text-[16px]"
          >
            {item.product_name}
          </Link>

          <p className="text-[13px] text-[#1F1210] lg:text-[15px]">
            {variant.size?.name
        ...
        <p className="text-[14px] font-bold text-[#1F1210] lg:text-[16px]">

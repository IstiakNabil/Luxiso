  ...
  if (isError || !order) {
    return (
      <div className="font-loomino flex min-h-[60vh] flex-col items-center justify-center gap-6 bg-[#F0E6D8] px-5 md:px-10 text-center">
        ...
        <Link
          to="/orders"
          className="text-[#8A6A2E] hover:underline"
        >
          Back to my orders
        </Link>
      </div>
    ...
    <div className="font-loomino min-h-[calc(100vh-110px)] bg-[#F0E6D8]">
      <div className="mx-auto max-w-[960px] px-5 md:px-10 py-[56px] lg:px-[108px]">
        ...
        <div className="mt-6 flex flex-wrap items-start justify-between gap-4">
          <div>
            <h1 className="text-[32px] font-semibold leading-[1.4] text-[#1F1210]">
        ...
        <div className="mt-10 border border-[#CBCBCB] bg-white p-8">
          ...
          {order.tracking_number && (
            <p className="mt-8 text-center text-[15px] text-[#606060]">
              Tracking number:{" "}
              <span className="font-bold text-[#1F1210]">
                {order.tracking_number}
              </span>
            </p>
          )}
        ...
        {/* Items */}
        <h2 className="mt-12 text-[20px] font-bold text-[#1F1210]">
          Items
        </h2>
        <div className="mt-4">
        ...
        <div className="mt-10 grid grid-cols-1 gap-8 md:grid-cols-2">
          <div>
            <h2 className="text-[20px] font-bold text-[#1F1210]">
              Shipping Address
            </h2>
            <div className="mt-4 space-y-1 border border-[#CBCBCB] bg-[#F6EFE8] p-6 text-[15px] leading-[1.8]">
          ...
          <div>
            ...
            <div className="mt-4 space-y-3 border border-[#CBCBCB] bg-[#F6EFE8] p-6 text-[16px]">
            ...
            {confirmingCancel ? (
              <div className="flex flex-wrap items-center gap-4">
                ...
                <button
                  ...
                  className="h-[44px] w-[120px] border border-[#8A6A2E] text-[#8A6A2E] transition hover:bg-[#F6EFE8]"
                >
                  Keep Order
                </button>
              </div>

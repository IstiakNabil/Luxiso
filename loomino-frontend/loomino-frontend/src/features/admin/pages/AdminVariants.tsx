...
function AdminVariants() {
  ...
  return (
    <div className="font-loomino">
      ...
      {isLoading && (
        <div className="rounded-2xl border border-[#EFE9DE] bg-white px-6 py-10 text-center text-[14px] text-[#B08C7A]">
          Loading…
        </div>
      )}
      {isError && (
          ...
          >
            <div className="flex items-center gap-4 border-b border-[#F1ECE2] px-6 py-4">
              ...
              <div className="flex-1">
                <p className="font-semibold text-[#3A1620]">
                  {v.product.name}
                </p>
            ...
            <div className="grid grid-cols-4 gap-4 px-6 py-4 text-[13px]">
              <div>
                <p className="text-[11px] uppercase text-[#B08C7A]">
                  Size
                </p>
                <p className="mt-1 text-[#3A1620]">
                  {v.size.name}
                </p>
              </div>
              <div>

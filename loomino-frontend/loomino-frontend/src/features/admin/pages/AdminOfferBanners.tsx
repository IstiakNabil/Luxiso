          ...
          <div>
            ...
            <label className="mb-4 block">
              ...
              <textarea
                ...
                rows={3}
                className="w-full rounded-lg border border-[#DDD3C0] bg-white px-3 py-2 text-[14px] text-[#3A1620] outline-none focus:border-[#A88548]"
              />
            </label>
            <label className="mb-4 block">
              <span className="mb-1.5 block text-[13px] font-medium text-[#3A2E1B]">
              ...
              <select
                ...
                className="h-[42px] w-full rounded-lg border border-[#DDD3C0] bg-white px-3 text-[14px] text-[#3A1620] outline-none focus:border-[#A88548]"
              >

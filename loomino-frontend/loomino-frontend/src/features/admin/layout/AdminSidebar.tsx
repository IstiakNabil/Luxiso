  ...
  return (
    <aside className="font-loomino flex h-screen w-[260px] shrink-0 flex-col border-r border-[#E4DACA] bg-white">
      ...
      <nav className="flex-1 overflow-y-auto px-4 py-6">
        {ADMIN_NAV.map((section) => (
          <div key={section.heading} className="mb-6">
            <p className="mb-2 px-2 text-[11px] font-semibold uppercase tracking-[1px] text-[#B08C7A]">
              {section.heading}
            </p>
      ...
      <div className="border-t border-[#E4DACA] p-4">
        <Link
          to="/admin/pos"
          className="mb-3 flex w-full items-center justify-center gap-2 rounded-lg bg-[#1E1B33] px-3 py-2.5 text-[13px] font-semibold text-white transition hover:bg-[#2E2A4D]"
        >
          <LayoutGrid size={16} className="text-[#7C6AE8]" />
          Open POS
        </Link>
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#5C1626] text-[14px] font-bold text-white">

    ...
    <div className="font-loomino fixed inset-0 z-[60] flex items-center justify-center">
      ...
      <div className="relative mx-6 flex w-full max-w-[854px] flex-col items-center gap-8 bg-white px-6 py-12 text-center">
        <button
          ...
          onClick={dismiss}
          aria-label="Close"
          className="absolute left-6 top-6 text-[#1F1210] transition hover:opacity-70"
        >
          <X size={24} />
        </button>

        <h2 className="text-[28px] font-semibold capitalize leading-[1.4] text-[#1F1210] md:text-[32px]">
          Welcome to Loomino
        </h2>

        <p
          className="text-[22px] capitalize italic leading-[1.8] text-[#1F1210] md:text-[24px]"
          style={{ fontFamily: "'Cormorant Garamond', serif" }}
        >
          Elegance in simplicity, Earth's harmony
        </p>

        <p className="text-[20px] font-bold capitalize leading-[1.4] text-[#1F1210] md:text-[24px]">
        ...
        <button
          ...
          className="h-[48px] w-full max-w-[392px] bg-[#5C1626] text-[16px] capitalize text-white transition hover:opacity-90"
        >
